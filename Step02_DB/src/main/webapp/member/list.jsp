...
<body>
	<%-- 
		...
		- 파라미터를 적절히 전달해서 포함된 jsp 페이지 내에서 해당 파라미터를 추출해서 어떤 로직을 수행할 수 있음.
		- 아래 같은 경우는 thisPage라는 파라미터 명으로 member라는 문자열을 전달하는 것임.
	...
	<div class="container">
		<a href="${pageContext.request.contextPath }/member/insertform.jsp" class="icon-link">
			...
			<!-- 보이지는 않지만 시각장애인분들을 위해서 포커스가 오면 읽어줌 -->
			<span class="visually-hidden">회원추가</span>
		</a>
		<h2 class="m-3">회원 목록 입니다.</h2>
